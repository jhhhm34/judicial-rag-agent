    ...
    def do_search(
        ...
        with self.load_vector_store().acquire() as vs:
            faiss_retriever = vs.as_retriever(
                ...
                search_kwargs={"k": top_k * 2, "score_threshold": score_threshold},
            )
            all_docs = []
            ...
            cache_key = self.kb_name
            bm25_retriever = None
            if cache_key in FaissKBService._bm25_cache:
                cached_retriever, cached_count = FaissKBService._bm25_cache[cache_key]
                if cached_count == doc_count:
                    bm25_retriever = cached_retriever
                    bm25_retriever.k = top_k * 2
            if bm25_retriever is None and doc_count > 0:
                ...
                FaissKBService._bm25_cache[cache_key] = (bm25_retriever, doc_count)
